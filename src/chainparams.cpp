...
static const Checkpoints::CCheckpointData data = {
    ...
    1356539,    // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "cari-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("fuzzbawls.pw", "cari-testnet.seed2.fuzzbawls.pw", true);
